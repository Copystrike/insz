...
export const fr: AppTranslations = {
    ...
    decode: {
        ...
        resultsChecksumValid: '<span class="text-green-600 font-semibold">Valide </span>',
        resultsChecksumInvalid: '<span class="text-red-600 font-semibold">Invalide </span>',
    ...
    client: {
        decoder: {
            algorithm: "Configuration d'algorithme:",
            algorithmAuto: "Automatique (19xx/20xx)",
            algorithm19xx: "Forcer 19xx",
            algorithm20xx: "Forcer 20xx",
            checksumSuggestion: "Suggestion de somme de contrôle :",
            validFor: "Valide pour",
            checksumStatus: "Somme de contrôle:",
            checksumCorrect: "Correcte",
            checksumInvalid: "Invalide",
            checksumMissing: "Manquante",
            checksumExpected: "Attendu",
            checksumWouldBe: "Serait",
            checksumForYear: "pour",
            birthDate: "Date de naissance:",
            gender: "Sexe:",
            birthOrder: "Ordre de naissance:",
            theNth: "Le",
            registeredThatDay: "enregistré ce jour-là",
            cautionChecksumInvalid: "ATTENTION: La somme de contrôle est invalide !",
            cautionChecksumMissing: "ATTENTION: La somme de contrôle est manquante ! Validation impossible.",
            yearAssumed: "L'année est présumée.",
            disclaimer: "Dérivation basée sur les algorithmes standard, à titre informatif uniquement.",
            input: "Valeur d'entrée:",
            datePart: "Partie date (AAMMJJ):",
            sequencePart: "Numéro de séquence (SSS):",
            checksumPart: "Somme de contrôle (CC):",
            errorInvalidType: "Type de saisie invalide.",
            errorInvalidLength: "Longueur invalide. 9 ou 11 chiffres attendus, mais",
            errorInvalidFormat: "Format invalide. Ne doit contenir que des chiffres.",
            errorInvalidSequence: "Numéro de séquence invalide",
            errorInvalidSequenceRange: "Doit être entre 001 et 998.",
            errorInvalidDate: "Date invalide",
            errorDateNotExist: "La date n'existe pas dans le calendrier.",
            errorUnknown: "Erreur de validation inconnue.",
            enterNumber: "Entrez un numéro de registre national à 9 ou 11 chiffres.",
            decoderTitle: "Décodeur de Numéro de Registre National",
            selectAlgorithm: "Algorithme:",
            unknownCount: "nombre inconnu"
        }
    }
};